            ...
            <div class="tab-header">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="nav-tab-one" data-bs-toggle="tab" data-bs-target="#tab-one" type="button" role="tab" aria-controls="tab-one" aria-selected="true">Trending</button>
                    </li>
                    {{-- <li class="nav-item" role="presentation">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="{{url('view-product/'.$item->slug)}}">
                                            <img class="default-img" src="{{asset('uploads/product/'.$item->image)}}" alt="">
                                            <img class="hover-img" src="{{asset('uploads/product/'.$item->image)}}" alt="">
                                        </a>
                                    </div>
                ...
                <div class="carausel-6-columns" id="carausel-6-columns">
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="{{url('view-category/'.$item->slug)}}"><img src="{{asset('uploads/category/'.$item->image)}}" alt=""></a>
            ...
            <div class="carausel-6-columns-cover position-relative">
                ...
                <div class="carausel-6-columns carausel-arrow-center" id="carausel-6-columns-2">
                    ...
                    <div class="product-cart-wrap small hover-up">
                        ...
                        <div class="product-content-wrap">
                            <h2><a href="{{url('view-product/'.$item->slug)}}">{{$item->name}}</a></h2>
                            <div class="rating-result" title="90%">
                                <span>
                                </span>
                            </div>
