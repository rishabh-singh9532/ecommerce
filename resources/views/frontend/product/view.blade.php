                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="detail-gallery">
                                        ...
                                        <div class="slider-nav-thumbnails pl-15 pr-15">
                                            <div><img src="{{ asset('uploads/product/' . $product->image) }}"
                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left">
                                                ...
                                                <ins><span
                                                        class="old-price font-md ml-15">{{ $product->original_price }}</span></ins>
                                        ...
                                        <div class="input-group text-center mb-3" style="width: 130px">
                                            <input type="hidden" value="{{ $product->id }}" name="prod_id"
                                                class="prod_id">
                                            <span class=" input-group-text decreament-btn ">-</span>
                                           
                                            <input type="text" name="quantity" class="form-control text-center qty-val"
                                                value="1">
                                            <span class="qty-down input-group-text increament-btn">+</span>
                                        </div>

                                        <div class="product-extra-link2">
                                            @if ($product->quantity > 0)
                                            <button type="submit" class="button button-add-to-cart addtocartbtn">Add to
                                                cart</button>
                                            @endif
                                        ...
                                        <ul class="product-meta font-xs color-grey mt-50">
                                            ...
                                            @if ($product->quantity > 0)
                                                <li>Availability:<span class="in-stock text-success ml-5"> In Stock</span>
                                                </li>
                                            @else
                                                <li>Availability:<span class="in-stock text-danger ml-5">Out ofStock</span>
                                                </li>
                                            @endif
                                        </ul>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".addtocartbtn").click(function(e) {
                ...
                var product_qty = $(this).closest('.product_data').find('.qty-val').val();
