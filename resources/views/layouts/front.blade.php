...
<head>
    ...
    {{-- autocomplete jquery for search  --}}
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    startautocompleteajax(response)
                    // availableTags = response;  // Assuming the response is an array of tags
                }
            });

            function startautocompleteajax(availableTags) {
            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="{{ url('/') }}"><img src="{{ asset('uploads/logo/1.png') }}" alt="logo"
                                class="w-25" height="70px"></a>
                    </div>
                    <div class="header-right">
                        <div class="search-style-1">
                            <form action="{{ url('front-search-product') }}" method="POST">
                                @csrf
                                <input type="search" name="searched" id="searchproduct" name="query"
            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                                ...
                                <ul>
                                    ...
                                    @else
                                        <li>
                                            {{-- <a href="{{ route('logout') }}"
                                                onclick="event.preventDefault();
                                                      document.getElementById('logout-form').submit();">My
                    ...
                    <div class="hotline d-none d-lg-block">
                        <p><i class="fi-rs-smartphone"></i><span>Toll Free</span> (+91) 7084378938 </p>
                    </div>
        ...
        <section class="newsletter p-30 text-white wow fadeIn animated">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5">
                        <!-- Subscribe Form -->
                        <form class="form-subcriber d-flex wow fadeIn animated" method="POST" action="{{route('newsletter')}}">
                            @csrf
                            <input type="email" name="newsletter" class="form-control bg-white font-small"
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            <div class="logo logo-width-1 wow fadeIn animated">
                                <a href="index.html"><img src="{{ asset('uploads/logo/1.png') }}"
                                        alt="logo"></a>
                            </div>
                            <h5 class="mt-20 mb-10 fw-600 text-grey-4 wow fadeIn animated">Contact</h5>
                            <p class="wow fadeIn animated">
                                <strong>Address: </strong>Antu Road Amethi 
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Phone: </strong>+91 7084378938
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>rishabhsingh9532060@gmail.com
                            </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="text-lg-end text-start font-sm text-muted mb-0">
                        &copy; <strong class="text-brand">Rishabh Singh</strong> All rights reserved
                    </p>
                </div>
            </div>
        </div>
